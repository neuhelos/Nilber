  ...
  return(
    ...
    <ThemeProvider theme={theme}>
      ...
      <div className={classes.root}>
        ...
        <Typography className={classes.text} align='center' variant="h5" style={{fontFamily: 'abel', fontWeight: 800}}>DATA/ANALYTICS/AI ENGINEER & FULL STACK SOFTWARE DEVELOPER</Typography>
        <Main />
        <Footer />
      </div>
    </ThemeProvider>
